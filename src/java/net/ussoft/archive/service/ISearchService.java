...
public interface ISearchService {
	 ...
	 * @throws IOException
	 */
	HashMap search(String tableName, List<Sys_templetfield> tmpList,String searchTxt,int currentPage,int pageSize) throws IOException;
	/**
	 * 根据关键字，在树节点下检索内容
	 * @param tableName		表名
	 * @param fields		查询字段
	 ...
	 * @throws IOException
	 */
	HashMap search(String tableName, List<Sys_templetfield> tmpList,String searchTxt,String treeid,int currentPage,int pageSize,HashMap<String, String> fMap) throws IOException;
	/**
	 * 电子全文检索
	 * @param keyword		检索内容
	 ...
	 * @return
	 */
	HashMap search(String keyword,String docserverid,List<Sys_tree> treeList,int currentPage,int pageSize);
