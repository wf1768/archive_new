<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%@ include file="/view/common/header_1.jsp"%>
...
<script>
	...
	function onClick(event, treeId, nodes) {
		if (nodes.isParent) {
			...
			window.location.href="${pageContext.request.contextPath}/templet/list.do?selectid="+nodes.id+"&m=${m}";
		}
	};
...
<div id="bodyer">
	...
	<div id="bodyer_right" style="background-color: #EFE5E2;">
		<table align="center" width="98%" height="50%" style="margin-top: 10px" >
			<tr >
				<td>当前位置：系统配置－档案库维护</td>
				<td align="right"><input type='text' id="queryValue" name="queryValue" size="30" value="${queryValue}"/>&nbsp;<input type="button" value="查询" class="btn" onClick="query(document.forms[0]);" />
				<input type="button" value="添加" class="btn" onClick="openAddProductTab()" />
				</td>
			</tr>
			...
			<tr>
				...
				<div class="scrollTable">
						<table class="table-Kang tableMain" id="table_main" align="center" width="100%" border=0 cellPadding=4 cellSpacing=1>
							...
							<c:if test="${fn:length(templetfields) == 0 }">
								<tr id="not" class=table-SbgList>
									<td colspan="14" height="200px"></td>
								</tr>
							</c:if>
